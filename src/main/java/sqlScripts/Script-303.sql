...
-- 		sft.form_key as formKey,
		...
		t4.principle_id
	from
-- 		(select * from pfm_work where business_type in ( 'patrol' , 'operationInspection' , 'periodicInspection' )) t1
		pfm_work t1
...
where
	1 = 1
	and 3 = 3
-- 	and t11.relationshipCode like concat(?, '001011')
-- 	and t11.relationshipStatus = 'enabled'
